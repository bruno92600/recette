  ...
  return (
    <div className="bg-[#faf9fb] p-10 flex-1">
      <div className="max-w-screen-lg mx-auto">
        ...
        <h1 className="font-bold text-3xl md:text-5xl mt-4">Recettes recommandées</h1>
        <p className="text-slate-500 font-semibold ml-1 my-2 text-sm tracking-tight">Choix populaires</p>
